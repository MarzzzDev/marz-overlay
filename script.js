...
function showTwitchLoginScreen() {
    ...
    const fadeNoCheckbox =
        document.createElement("label");

    fadeNoCheckbox.style.cssText = `
        display: flex;
        align-items: center;
        gap: 8px;
    ...
    box.appendChild(fadeLabel);
    box.appendChild(fadeInput);
    box.appendChild(fadeNoCheckbox);
